# Getting Started with JavaCopier

Welcome to **JavaCopier**, the official Java client library for MetaRPC's ultra-low latency Trade Copier engine.

## Installation

Install JavaCopier using your language's package manager:
